...
# Step 7
# This script is used to perform DE-analysis between healthy path_MMR carriers and sporadic rectal cancer patients (SRME).
...
# Choose conditions of interest (healthy LS, n = 81 and SRME, n = 24)
